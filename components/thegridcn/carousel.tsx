  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded border border-primary/20 bg-card/80 backdrop-blur-sm transition-all duration-300 hover:border-primary/40">
        ...
        {/* Top accent line */}
        <div className="absolute top-0 left-0 right-0 z-10 h-px bg-linear-to-r from-transparent via-primary/40 to-transparent" />
        ...
        {/* Bottom accent line */}
        <div className="absolute bottom-0 left-0 right-0 z-10 h-px bg-linear-to-r from-transparent via-primary/40 to-transparent" />
