...
export function ModalButton({
  ...
  return (
    <button
      type="button"
      className={cn(
        "rounded border px-4 py-1.5 font-mono text-[10px] tracking-widest uppercase transition-all",
        variant === "default" &&
          "border-primary/20 text-foreground/50 hover:bg-primary/5 hover:text-foreground/70",
        variant === "primary" &&
