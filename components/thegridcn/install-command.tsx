...
export function InstallCommand({
  ...
  return (
    ...
    >
      ...
      {/* Corner decorations */}
      <div className="pointer-events-none absolute top-0 left-0 h-2 w-2 border-t border-l border-primary/40" />
      <div className="pointer-events-none absolute top-0 right-0 h-2 w-2 border-t border-r border-primary/40" />
      <div className="pointer-events-none absolute bottom-0 left-0 h-2 w-2 border-b border-l border-primary/40" />
      <div className="pointer-events-none absolute right-0 bottom-0 h-2 w-2 border-r border-b border-primary/40" />
      ...
      {/* Bottom glow */}
      <div className="pointer-events-none absolute right-0 bottom-0 left-0 h-px bg-linear-to-r from-transparent via-primary/20 to-transparent" />
    </div>
  )
}
