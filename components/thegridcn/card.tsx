...
function TronCard({
  ...
  return (
    ...
    >
      ...
      {/* Corner decorations */}
      <div className="pointer-events-none absolute top-0 left-0 z-10 h-4 w-4 border-t-2 border-l-2 border-primary/40" />
      <div className="pointer-events-none absolute top-0 right-0 z-10 h-4 w-4 border-t-2 border-r-2 border-primary/40" />
      <div className="pointer-events-none absolute bottom-0 left-0 z-10 h-4 w-4 border-b-2 border-l-2 border-primary/40" />
      <div className="pointer-events-none absolute right-0 bottom-0 z-10 h-4 w-4 border-r-2 border-b-2 border-primary/40" />
...
function TronCardDescription({
  ...
  return (
    <CardDescription
      ...
      className={cn(
        "font-mono text-[10px] tracking-widest text-foreground/60 uppercase",
        className
      )}
      {...props}
    />
...
function TronCardFooter({ className, ...props }: TronCardFooterProps) {
  return (
    <CardFooter
      ...
      className={cn("border-t border-primary/20 px-4 py-3", className)}
      {...props}
    />
  )
}
