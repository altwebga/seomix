...
export function Footer({
  ...
  return (
    ...
    >
      {/* Top edge glow */}
      <div className="pointer-events-none absolute left-0 right-0 top-0 h-px bg-linear-to-r from-transparent via-primary/60 to-transparent" />
      <div className="pointer-events-none absolute left-0 right-0 top-0 h-8 bg-linear-to-b from-primary/5 to-transparent" />

      {/* Scanline overlay */}
      <div className="pointer-events-none absolute inset-0 bg-[repeating-linear-gradient(0deg,transparent,transparent_2px,rgba(0,0,0,0.03)_2px,rgba(0,0,0,0.03)_4px)]" />

      {/* Subtle grid pattern */}
      <div className="pointer-events-none absolute inset-0 opacity-[0.03] bg-[linear-gradient(to_right,currentColor_1px,transparent_1px),linear-gradient(to_bottom,currentColor_1px,transparent_1px)]" />
      ...
      <div className="relative mx-auto max-w-6xl px-6 py-10">
        ...
        {copyright && (
          <>
            <div className="mt-8 h-px bg-linear-to-r from-transparent via-primary/20 to-transparent" />
