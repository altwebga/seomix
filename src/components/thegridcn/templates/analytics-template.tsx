          ...
          <div className="relative overflow-hidden rounded border border-primary/30 bg-card/80 p-4 backdrop-blur-sm">
            ...
            <div className="mt-6 flex flex-col items-center justify-center">
              <div className="flex items-center gap-2">
                ...
                <span className="font-[family-name:var(--font-inter)] text-4xl font-bold text-primary">
                  {REALTIME_USERS}
                </span>
              </div>
              ...
              <div className="mt-4 grid w-full grid-cols-3 gap-2 border-t border-primary/10 pt-4">
                <div className="text-center">
                  <div className="font-mono text-sm font-semibold text-foreground/70">
                    312
                  </div>
                  <div className="font-mono text-[8px] uppercase tracking-widest text-foreground/30">
                    /products
                  </div>
                </div>
                <div className="text-center">
