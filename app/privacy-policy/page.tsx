    ...
    <div className="my-6">
      ...
      <section className="mb-8">
        ...
        <p className="mb-4">
          ...
          безопасности персональных данных, предпринимаемые{" "}
        ...
        <ol className="list-decimal list-inside space-y-2">
          ...
          <li>
            ...
            <span className="text-blue-600 underline">https://seomix.ru</span>.
          </li>
        </ol>
      </section>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>Субъекты персональных данных имеют право:</li>
          <ul className="list-disc list-inside pl-4 space-y-2">
            <li>
          ...
          <li>Субъекты персональных данных обязаны:</li>
          <ul className="list-disc list-inside pl-4 space-y-2">
      ...
      <section className="mb-8">
        ...
        <div className="overflow-x-auto">
          <table className="table-auto w-full text-left">
            <thead>
              <tr>
                <th className="px-4 py-2 border">Цель обработки</th>
                <th className="px-4 py-2 border">Персональные данные</th>
                <th className="px-4 py-2 border">Правовые основания</th>
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal list-inside space-y-2">
          ...
          <li>
            ...
            <span className="text-blue-600 underline">support@seomix.ru</span> с
      ...
      <section className="mb-8">
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>
            ...
            <span className="text-blue-600 underline">support@seomix.ru</span>.
          </li>
          <li>
          ...
          <li>
            ...
            Интернет по адресу{" "}
            <span className="text-blue-600 underline">
              https://seomix.ru/privacy-policy
            </span>
            .
          </li>
        </ol>
